        ...
        <div className="relative container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent/10 rounded-full border-2 border-accent/30 backdrop-blur-sm">
              ...
              <span className="font-semibold font-poppins text-accent text-xl">Create Magic in Minutes</span>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-background via-secondary/10 to-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 space-y-3 animate-fade-in">
            ...
            <p className="text-muted-foreground font-poppins text-xl">
                  ...
                  <Card className="border-2 border-primary/30 shadow-2xl">
                    ...
                    <Card className={`border-2 ${index % 2 === 0 ? 'border-primary/30 hover:shadow-primary/20' : 'border-accent/30 hover:shadow-accent/20'} shadow-2xl transition-all duration-300 page-turn overflow-hidden group`}>
                      <CardContent className="p-0 relative">
                        <img src={image.image_url} alt={image.alt_text} className="w-full h-auto rounded-lg group-hover:scale-105 transition-transform duration-500" />
